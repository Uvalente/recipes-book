...
import validate from '../newRecipe/recipeValidation'
...
const EditRecipe = (props) => {
  ...
  const {
    ...
    removeIngredient,
    errors
  } = useForm(validate, props.user, id)
  ...
  return (
    <div>
      <form onSubmit={recipeHandleSubmit} noValidate className='bg-white shadow-md rounded-lg m-2 lg:max-w-4xl xl:max-w-6xl lg:mx-auto lg:my-12 px-4 py-6 lg:p-10 xl:px-12'>
        <h3 className='uppercase font-semibold text-gray-900 tracking-wide text-center text-xl lg:py-2'>Edit Recipe</h3>
        ...
        <button className='mt-6 bg-blue-700 hover:bg-blue-600 text-white font-semibold py-1 px-4 border-b-4 border-blue-900 hover:border-blue-800 rounded-md'>Update</button>
      </form >
    </div>
  )
}
